<?php
// Heading
$_['heading_title']      	= 'Oceanpayment DCEP Payment';

// Text 
$_['text_payment']       	= 'Payment';
$_['text_success']       	= 'Success: You have modified DCEP account details!';
$_['text_edit']          	= 'Edit Oceanpayment DCEP Payment';
$_['text_op_dcep'] 	    = '<img src="view/image/payment/op_dcep.png" alt="dcep" height="25"  title="dcep" style="border: 1px solid #EEEEEE;" />';
...
// Error
$_['error_permission']                = 'Warning: You do not have permission to modify Oceanpayment DCEP!';
