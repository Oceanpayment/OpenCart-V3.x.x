<?php
// Heading
$_['heading_title']      	= 'Oceanpayment Octopus Payment';

// Text 
$_['text_payment']       	= 'Payment';
$_['text_success']       	= 'Success: You have modified  account details!';
$_['text_edit']          	= 'Edit Oceanpayment Octopus Payment';
$_['text_op_octopus'] 	    = '<img src="view/image/payment/op_octopus.svg" alt="Octopus" height="25"  title="Octopus" style="border: 1px solid #EEEEEE;" />';
...
// Error
$_['error_permission']                = 'Warning: You do not have permission to modify Oceanpayment Octopus!';
