<?php
// Heading
$_['heading_title']      	= 'Oceanpayment JeniusPay Payment';

// Text 
$_['text_payment']       	= 'Payment';
$_['text_success']       	= 'Success: You have modified JeniusPay account details!';
$_['text_edit']          	= 'Edit Oceanpayment JeniusPay Payment';
$_['text_op_jeniuspay'] 	        = '<img src="view/image/payment/op_JeniusPay.png" alt="JeniusPay" height="25"  title="JeniusPay" style="border: 1px solid #EEEEEE;" />';
...
// Error
$_['error_permission']                = 'Warning: You do not have permission to modify Oceanpayment JeniusPay!';
