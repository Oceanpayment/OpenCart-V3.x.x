<?php
// Heading
$_['heading_title']      	= 'Oceanpayment Rabbit-LinePay Payment';

// Text 
$_['text_payment']       	= 'Payment';
$_['text_success']       	= 'Success: You have modified rabbitlinepay account details!';
$_['text_edit']          	= 'Edit Oceanpayment Rabbit-LinePay Payment';
$_['text_op_rabbitlinepay'] = '<img src="view/image/payment/op_rabbitlinepay.png" alt="rabbitlinepay" height="25"  title="rabbitlinepay" style="border: 1px solid #EEEEEE;" />';
...
// Error
$_['error_permission']                = 'Warning: You do not have permission to modify Oceanpayment Rabbit-LinePay!';
