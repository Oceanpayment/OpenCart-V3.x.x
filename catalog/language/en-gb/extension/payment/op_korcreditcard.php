...
// Text
$_['text_title']        = 'KOR_Credit Card Payment <br/><img src="catalog/view/theme/default/image/op_korcreditcard.png" alt="KOR_Credit Card">';
$_['text_response']     = 'Response from KOR_Credit Card:';
