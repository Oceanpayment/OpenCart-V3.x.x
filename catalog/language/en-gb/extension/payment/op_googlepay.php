...
// Text
$_['text_title']        = 'GooglePay Payment <br/><img src="catalog/view/theme/default/image/op_googlepay.svg" width="70" alt="GooglePay">';
$_['text_response']     = 'Response from GooglePay:';
