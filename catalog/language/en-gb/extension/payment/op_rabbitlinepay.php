...
// Text
$_['text_title']        = 'Rabbit-LinePay Payment <br/><img src="catalog/view/theme/default/image/op_rabbitlinepay.png" alt="Rabbit-LinePay">';
$_['text_response']     = 'Response from Rabbit-LinePay:';
